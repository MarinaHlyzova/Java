...
public class example6 {
    public static void main(String[] args) throws IOException {
        ...
        try{
            in = new FileReader("C:\\Users\\user\\IdeaProjects\\java-core_2022-2023/MyFile1.txt"); // файл для чтения
            out = new FileWriter("C:\\Users\\user\\IdeaProjects\\java-core_2022-2023/MyFile2.txt", true); // файл для записи разрешено добавление
